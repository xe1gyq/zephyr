...
```bash
user@workstation:~/Intel/Zephyr/zephyr-project/samples/hello_world/microkernel$ make pristine
user@workstation:~/Intel/Zephyr/zephyr-project/samples/hello_world/microkernel$ make BOARD=arduino_101
